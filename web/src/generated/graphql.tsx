...
export type ProjectByPriorityQuery = {
  __typename?: "Query";
  projectByPriority: Array<{
    __typename?: "ProjectByPriority";
    low: string;
    medium: string;
    high: string;
...
export type ProjectByStatusQuery = {
  __typename?: "Query";
...
export type ProjectByTypeQuery = {
  __typename?: "Query";
  projectByType: Array<{
    __typename?: "ProjectByType";
    issue: string;
...
export function useProjectByPriorityQuery(
  options?: Omit<Urql.UseQueryArgs<ProjectByPriorityQueryVariables>, "query">
) {
  return Urql.useQuery<ProjectByPriorityQuery, ProjectByPriorityQueryVariables>(
    { query: ProjectByPriorityDocument, ...options }
  );
}
...
export function useProjectByStatusQuery(
  options?: Omit<Urql.UseQueryArgs<ProjectByStatusQueryVariables>, "query">
) {
  return Urql.useQuery<ProjectByStatusQuery, ProjectByStatusQueryVariables>({
    query: ProjectByStatusDocument,
    ...options,
  });
}
...
export function useProjectByTypeQuery(
  options?: Omit<Urql.UseQueryArgs<ProjectByTypeQueryVariables>, "query">
) {
  return Urql.useQuery<ProjectByTypeQuery, ProjectByTypeQueryVariables>({
    query: ProjectByTypeDocument,
    ...options,
  });
}
