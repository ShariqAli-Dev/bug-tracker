...
export type AssignUsersMutation = {
  __typename?: "Mutation";
  assignUsers: boolean;
};
...
export type UpdateProjectMutation = {
  __typename?: "Mutation";
  updateProject?: { __typename?: "Project"; id: number } | null;
};
...
export type ArchivedProjectTicketsQuery = {
  __typename?: "Query";
  archivedProjectTickets: Array<{
    __typename?: "Ticket";
    id: number;
    projectId: number;
    creator: string;
...
export type AssignedDevelopersQuery = {
  __typename?: "Query";
...
export type AssignedPersonnelQuery = {
  __typename?: "Query";
...
export type AvilableUsersQuery = {
  __typename?: "Query";
  avilableUsers: Array<{
    __typename?: "Users";
    id: number;
...
export type MeQuery = {
  __typename?: "Query";
  me?: { __typename?: "Users"; name: string; id: number; role: string } | null;
};
...
export type TicketsByPriorityQuery = {
  __typename?: "Query";
  ticketsByPriority: {
    __typename?: "TicketsByPriority";
    low: string;
...
export function useArchiveTicketMutation() {
  return Urql.useMutation<
    ...
    ArchiveTicketMutationVariables
  >(ArchiveTicketDocument);
}
...
export function useAssignUsersMutation() {
  return Urql.useMutation<AssignUsersMutation, AssignUsersMutationVariables>(
    AssignUsersDocument
  );
}
...
export function useCreateTicketMutation() {
  return Urql.useMutation<CreateTicketMutation, CreateTicketMutationVariables>(
...
export function useArchivedProjectTicketsQuery(
  options: Omit<
    Urql.UseQueryArgs<ArchivedProjectTicketsQueryVariables>,
    "query"
  >
) {
  return Urql.useQuery<
    ArchivedProjectTicketsQuery,
    ArchivedProjectTicketsQueryVariables
  >({ query: ArchivedProjectTicketsDocument, ...options });
}
...
export function useAssignedDevelopersQuery(
  options: Omit<Urql.UseQueryArgs<AssignedDevelopersQueryVariables>, "query">
) {
  return Urql.useQuery<
    AssignedDevelopersQuery,
    AssignedDevelopersQueryVariables
  >({ query: AssignedDevelopersDocument, ...options });
}
...
export function useAssignedPersonnelQuery(
  options: Omit<Urql.UseQueryArgs<AssignedPersonnelQueryVariables>, "query">
) {
  return Urql.useQuery<AssignedPersonnelQuery, AssignedPersonnelQueryVariables>(
    { query: AssignedPersonnelDocument, ...options }
  );
}
...
export function useAvilableUsersQuery(
  options: Omit<Urql.UseQueryArgs<AvilableUsersQueryVariables>, "query">
) {
  return Urql.useQuery<AvilableUsersQuery, AvilableUsersQueryVariables>({
    query: AvilableUsersDocument,
    ...options,
  });
}
...
export function useTicketQuery(
  ...
  return Urql.useQuery<TicketQuery, TicketQueryVariables>({
...
export function useTicketCommentsQuery(
  options: Omit<Urql.UseQueryArgs<TicketCommentsQueryVariables>, "query">
) {
  return Urql.useQuery<TicketCommentsQuery, TicketCommentsQueryVariables>({
    query: TicketCommentsDocument,
    ...options,
  });
}
...
export function useTicketsByPriorityQuery(
  options?: Omit<Urql.UseQueryArgs<TicketsByPriorityQueryVariables>, "query">
) {
  return Urql.useQuery<TicketsByPriorityQuery, TicketsByPriorityQueryVariables>(
    { query: TicketsByPriorityDocument, ...options }
  );
}
...
export function useTicketsByStatusQuery(
  options?: Omit<Urql.UseQueryArgs<TicketsByStatusQueryVariables>, "query">
) {
  return Urql.useQuery<TicketsByStatusQuery, TicketsByStatusQueryVariables>({
    query: TicketsByStatusDocument,
    ...options,
  });
}
...
export function useTicketsByTypeQuery(
  options?: Omit<Urql.UseQueryArgs<TicketsByTypeQueryVariables>, "query">
) {
  return Urql.useQuery<TicketsByTypeQuery, TicketsByTypeQueryVariables>({
    query: TicketsByTypeDocument,
    ...options,
  });
}
...
export function useUserTicketsQuery(
  options?: Omit<Urql.UseQueryArgs<UserTicketsQueryVariables>, "query">
) {
  return Urql.useQuery<UserTicketsQuery, UserTicketsQueryVariables>({
    query: UserTicketsDocument,
    ...options,
  });
}
